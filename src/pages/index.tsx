...
const Page = () => {
  ...
  return (
    <IntlProvider locale={lang} messages={getLocale(lang)}>
      <Helmet>
        <title>{title}</title>
        <meta name="description" content="免费在线简历制作工具，支持多种模板、自定义主题色、国际化(中/英)、实时预览和PDF下载。快速创建专业简历，无需编程基础。" />
        <meta name="keywords" content="简历制作,在线简历,简历生成器,简历模板,简历下载" />
        <meta property="og:title" content="Resume Creator - 在线简历制作" />
        <meta property="og:description" content="免费在线简历制作工具，支持多种模板、自定义主题色、国际化(中/英)、实时预览和PDF下载。" />
      </Helmet>
      <Header />
      <Content />
      <Footer />
